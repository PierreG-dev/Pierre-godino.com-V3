...
function backgroundInit() {
  document.getElementById('profil').style.backgroundImage =
    'url(RES/profil.jpg)';
...
function firsttosecond() {
  document.getElementById('container1').style.transform =
    'translate3d(-110%,0,0)';
  document.getElementById('container2').style.transform =
    'translate3d(-110%,0,0)';
  document.getElementById('container3').style.transform =
    'translate3d(-110%,0,0)';
